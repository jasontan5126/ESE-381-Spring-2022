...
ISR(PORTB_PORT_vect){
	...
	toUpperCase = receiveData - 0x20;
	UART_sw_write(receiveData - 0x20);	  //Send as an uppercase letters
	PORTB_INTFLAGS |= PORT_INT1_bm;		  //Clear the interrupt for PB1
}
